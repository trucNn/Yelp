...
# MAGIC %md # Step 1: What Tables Do I Have?
...
# MAGIC %md
# MAGIC ### Step 2: The Following Cell Must Be Run Before Continuing!
# MAGIC The following code cell defines the `process_tables` function and its supporting functions. If you do not run it first, the `process_tables` function will not work because it does not exist.
# MAGIC
...
# MAGIC %md ### Step 3: Functions for processing tables
# MAGIC
# MAGIC **NOTE:** You must have run the above cell that defines the `process_tables()` function and its supporting functions.
# MAGIC
...
# MAGIC
# MAGIC ### Edit the following cell for tables to be rebuilt
# MAGIC See discussion above in the markdown cell about the parameters to use

# COMMAND ----------

my_list=["project_table","project_reviews_table", "user_gender_table"]
